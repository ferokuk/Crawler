...
import time
import re
class CooksResumeSpider(scrapy.Spider):
    name = 'cooks_spider'
    ...
    def start_requests(self):
        ...
        for i in range(0, 200):
            url = f"https://hh.ru/search/vacancy?search_field=name&search_field=company_name&search_field=description&text=%D0%BF%D0%BE%D0%B2%D0%B0%D1%80&hhtmFrom=vacancy_search_catalog&items_on_page=10&page={i}"
    ...
    def parse(self, response):
        ...
        if "повар" not in str(position).lower():
            return
